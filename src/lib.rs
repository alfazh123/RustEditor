...
use crate::{color::adjust_color_handler, light::adjust_ligth};
...
#[wasm_bindgen]
pub fn adjust_contrasts_image(image_data: &[u8], contrasts: f64) -> Vec<u8> {
...
#[wasm_bindgen]
pub fn adjust_light_image(image_data: &[u8], contrasts: f64, exposure: f64) -> Vec<u8> {
    adjust_ligth(image_data, contrasts, exposure)
}